using ZippyNeuron.Kata.NotVerySecure;

namespace ZippyNeuron.Kata.Test.NotVerySecure;

[TestFixture]
internal class NotVerySecureTests
{
    ...
    public bool Test(string str) => NotVerySecureKata.Alphanumeric(str);
}